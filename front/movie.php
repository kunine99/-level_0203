            ...
            ?>
                <div>
                    ...
                    <div style="display:flex">
                        ...
                        <div>
                            <div>分級:
                                <!-- 我們之前有做一個小小的取巧，把我圖片的名稱改成我的副檔名 
                                     vertical-align 垂直對齊 僅限於行內inline的或者是text的東西
                                    通常對應一個有高度的東西(圖片 div 元素之類的)-->
                                <img src="icon/<?= $row['level']; ?>.png" style="width:25px vertical-align:auto">
                                <!-- 在$Movie這個資料表/物件裡面,你只要回傳level這個東西給我
                                     然後把你的level的值帶進來給我,我就會把文字吐給你 -->
                    ...
                    <div>
                        <!-- js的導頁方式有
                        1.replace 這方法會將新的URL替換當前的URL。因此使用者將無法返回到先前的URL(=當前的url瀏覽紀錄沒有)
                        2.href  兩種都可以用
                        ?do=intro&id 的id 是我們要把id帶過去-->
